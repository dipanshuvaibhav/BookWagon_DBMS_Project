					...
					<div class="col-lg-8">
						<div class="main-navigation flex-lg-right">
							<ul class="main-menu menu-right ">
								...
								<!-- Shop -->
								<li class="menu-item has-children mega-menu">
									<a href="shop-grid-left-sidebar.html)">shop <i
											class="fas fa-chevron-down dropdown-arrow"></i></a>
                ...
                <div class=" col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-footer pb--40">
                        ...
                        <div class="footer-contact">
                            <p><span class="label">Address:</span><span class="text">SG Palya, Bengaluru</span></p>
							<p><span class="label">Phone:</span><span class="text">+000 0000 000</span></p>
							<p><span class="label">Email:</span><span class="text">team4@gmail.com</span></p>
                        </div>
                    </div>
                </div>

                        ...
                        <div class="col-lg-3">
                            <div class="header-phone color-white">
                                ...
                                <div class="text">
                                    ...
                                    <p class="font-weight-bold number">+91-1800-CALLBW</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
...
===================================== -->
    <footer class="site-footer">
                ...
                <div class=" col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-footer pb--50">
                        ...
                        <div class="footer-contact">
                            <p><span class="label">Address:</span><span class="text">Christ University, Hosur Main Road, Bangalore</span></p>
                            <p><span class="label">Phone:</span><span class="text">+18088 CALL BOOKWAGON</span></p>
                            <p><span class="label">Email:</span><span class="text">suport@bookwagon.com</span></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="copyright-heading">Why buy a book when you can rent it.</p>
                <a href="#" class="payment-block">
                    <img src="image/icon/payment.png" alt="">
                </a>
                <p class="copyright-text">Copyright © 2021 <a href="#" class="author">BookWagon</a>. All Right Reserved.
                    <br>
